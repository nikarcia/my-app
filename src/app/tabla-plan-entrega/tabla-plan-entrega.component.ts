...
@Component({
  selector: 'app-tabla-plan-entrega',
  templateUrl: './tabla-plan-entrega.component.html',
  styleUrls: ['./tabla-plan-entrega.component.css']
})
export class TablaPlanEntregaComponent implements OnInit {
planesEntrega: any[] = [];
numeroGuia:any;
...
nombreCliente: any;
  ...
  ngOnInit() {
    const url = 'http://ec2-3-133-155-146.us-east-2.compute.amazonaws.com:8080/api/planes-entrega-terrestre'; // Reemplaza con la URL correcta de tu API REST para obtener la lista de planes de entrega
  ...
  consultarPorFiltros() {
    ...
    if (this.placaVehiculo) {
      params = params.set('placaVehiculo', this.placaVehiculo);
    }
    ...
    this.http.get<any[]>('http://ec2-3-133-155-146.us-east-2.compute.amazonaws.com:8080/api/planes-entrega-terrestre', { params }).subscribe(
      (data) => {
