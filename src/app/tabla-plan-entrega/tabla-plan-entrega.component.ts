...
nombreCliente: any;
  ...
  ngOnInit() {
    const url = 'http://localhost:8080/api/planes-entrega-terrestre'; // Reemplaza con la URL correcta de tu API REST para obtener la lista de planes de entrega
  ...
  consultarPorFiltros() {
    ...
    this.http.get<any[]>('http://localhost:8080/api/planes-entrega-terrestre', { params }).subscribe(
      (data) => {
